...
# Import the Calculation class and the arithmetic operation functions (add, subtract, multiply, divide).
...
@pytest.mark.parametrize("a, b, operation, expected", [
    ...
    (Decimal('5'), Decimal('5'), subtract, Decimal('0')),  # Test subtraction
    (Decimal('5'), Decimal('5'), multiply, Decimal('25')),  # Test multiplication
    (Decimal('5'), Decimal('1'), divide, Decimal('5')),  # Test division
    (Decimal('5.5'), Decimal('0.5'), add, Decimal('6.0')),  # Test addition with decimals
    (Decimal('5.5'), Decimal('0.5'), subtract, Decimal('5.0')),  # Test subtraction with decimals
    (Decimal('5.5'), Decimal('2'), multiply, Decimal('11.0')),  # Test multiplication with decimals
    (Decimal('5'), Decimal('0.5'), divide, Decimal('10')),  # Test division with decimals
])
